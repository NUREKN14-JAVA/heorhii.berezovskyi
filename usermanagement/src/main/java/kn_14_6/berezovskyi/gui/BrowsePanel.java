...
public class BrowsePanel extends JPanel implements ActionListener {
	...
	public void initTable() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, e.getMessage(),
					Messages.getString("error in BrowsePanel"), //$NON-NLS-1$
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ("delete".equals(actionCommand)) {
			...
			int answer = JOptionPane.showConfirmDialog(parent,
					"U really want to do this, dog?", "Confirmation",
	...
	private User getSelectedUser() {
		...
		if (selectedRow == -1) {
			JOptionPane.showMessageDialog(this, "User wasn't selected",
					"Error", JOptionPane.INFORMATION_MESSAGE);
			return null;
		}
		User user = ((UserTableModel) userTable.getModel())
				.getUserByRow(selectedRow);
		return user;
	}
